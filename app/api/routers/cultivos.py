...
from app.models.models import Usuario, CampoCultivo, CampoCultivoOperador
...
def obtener_cultivo_operador(
    ...
    return _get_cultivo_activo(campo_cultivo_id, db)
...
def listar_todos_los_cultivos(
    ...
    return db.query(CampoCultivo).filter(CampoCultivo.activo == True).order_by(CampoCultivo.created_at.desc()).all()
